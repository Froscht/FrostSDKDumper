...
// Generated by FrostDumper on Sep 10 2026 10:45:47
...
constexpr uint64_t GWORLD_RVA         = 0x10F2A580ULL;  // MODULE_BASE + this -> UWorld**
...
namespace Offsets {
    ...
    constexpr uint32_t UStruct_ChildProperties = 0x108;
    constexpr uint32_t UStruct_PropertiesSize = 0xD0;
    constexpr uint32_t FField_NamePrivate     = 0x90;
    constexpr uint32_t FField_Next            = 0x50;
    constexpr uint32_t FField_Owner           = 0x68;
