...
// Generated by FrostDumper on Aug 11 2026 20:36:29
...
constexpr uint64_t GWORLD_RVA         = 0xE7B7548ULL;  // MODULE_BASE + this → UWorld**
...
namespace Offsets {
    ...
    constexpr uint32_t FObjectProperty_Class  = 0x138;
    constexpr uint32_t FBoolProperty_FieldSize = 0x120;
    constexpr uint32_t FArrayProperty_Inner   = 0x118;
