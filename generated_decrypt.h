...
// Generated by FrostDumper on Aug  5 2026 22:41:43
// Patch image size: 0x11853000
// =============================================================================
//
...
constexpr uint64_t GNAME_POOL_BASE    = 0xE638AF8ULL;  // MODULE_BASE + this
constexpr uint64_t KEY_TABLE_RVA      = 0xEAF5D88ULL;  // MODULE_BASE + this
constexpr uint64_t GWORLD_RVA         = 0xE83FC58ULL;  // MODULE_BASE + this → UWorld**
constexpr uint64_t GOBJECT_ARRAY_RVA  = 0xE6ED190ULL;  // MODULE_BASE + this → FChunkedFixedUObjectArray
...
static inline int ComputeSlotIndex(uint64_t ObjAddr) {
    ...
    uint32_t H = Rotl32(Lo, 25) * 0x01000193u + 0x31F5C55Fu;
    H = Rotl32(H, 15) * 0x01000193u + Hi + 0x31F5C55Fu;
    H = Rotl32(H, 25) * 0x01000193u + 0x31F5C55Fu;
    H = Rotl32(H, 15) * 0x01000193u + 0x31F5C55Fu;
    return ((H ^ (H >> 16)) & 3) ^ 2;
}
...
static inline uint64_t FNameResolveEntry(uint32_t CI) {
    ...
    uint64_t B1 = SoftPshuflw(Rotl64(Raw1, 0), 0x00) ^ 0x0000000000000000ULL;
    uint64_t B2 = SoftPshuflw(Rotl64(Raw2, 0), 0x00) ^ 0x0000000000000000ULL;
...
namespace Offsets {
    ...
    constexpr uint32_t UStruct_PropertiesSize = 0xD8;
    constexpr uint32_t FField_NamePrivate     = 0xA0;
    constexpr uint32_t FField_Next            = 0x100;
    ...
    constexpr uint32_t FProperty_ArrayDim     = 0xE0;
    ...
    constexpr uint32_t UFunction_NativeFunc   = 0x148;
} // namespace Offsets
