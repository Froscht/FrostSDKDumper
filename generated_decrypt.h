...
// Generated by FrostDumper on Aug 13 2026 21:56:01
...
static inline uint64_t FNameResolveEntry(uint32_t CI) {
    ...
    uint64_t B1 = SoftPshuflw(Rotl64(Raw1, 13), 0x93) ^ 0x0000000141445EA0ULL;
    uint64_t B2 = SoftPshuflw(Rotl64(Raw2, 13), 0x93) ^ 0x0000000141445EA0ULL;
