...
// Generated by FrostDumper on Jul 17 2026 21:09:55
// Patch image size: 0x117E1000
// =============================================================================
//
...
constexpr uint64_t GWORLD_RVA         = 0xE83FC58ULL;  // MODULE_BASE + this → UWorld**
constexpr uint64_t GOBJECT_ARRAY_RVA  = 0xE7ADF20ULL;  // MODULE_BASE + this → FChunkedFixedUObjectArray
...
static inline uint64_t DecryptUObjectSlot_QD(const uint8_t Enc[16]) {
    ...
    memcpy(&Lo, Enc, 8);
    memcpy(&Hi, Enc + 8, 8);
    Lo = Rotl64(Lo, 29); Hi = Rotl64(Hi, 29);
    Lo = SoftPshuflw(Lo, 0x39);
    { uint32_t D0=Rotl32((uint32_t)Lo,5), D1=Rotl32((uint32_t)(Lo>>32),5),
               D2=Rotl32((uint32_t)Hi,5), D3=Rotl32((uint32_t)(Hi>>32),5);
...
static inline uint32_t DecryptFFieldName(uint64_t Encrypted) {
    ...
    { uint16_t W[4]; memcpy(W, &V, 8);
      ...
      memcpy(&V, W, 8); }
    { uint8_t Mask[8] = {0x07,0x06,0x04,0x05,0x02,0x03,0x00,0x01};
...
static inline int32_t DecryptPropertyOffset(uint32_t Stored) {
    return (int32_t)(Bswap32(Stored) ^ 0xA271DBC5u);
}
...
namespace Offsets {
    ...
    constexpr uint32_t UStruct_ChildProperties = 0xF0;
    constexpr uint32_t UStruct_PropertiesSize = 0xD0;
    constexpr uint32_t FField_NamePrivate     = 0xA0;
    constexpr uint32_t FField_Next            = 0x78;
    constexpr uint32_t FField_Owner           = 0x0;
    constexpr uint32_t FField_ClassPrivate    = 0x0;
    constexpr uint32_t FProperty_Offset       = 0xE4;
    constexpr uint32_t FProperty_ElementSize  = 0xD0;
    constexpr uint32_t FProperty_ArrayDim     = 0x110;
    constexpr uint32_t FStructProperty_Struct = 0x138;
    constexpr uint32_t FObjectProperty_Class  = 0x138;
    constexpr uint32_t FBoolProperty_FieldSize = 0x138;
    constexpr uint32_t FArrayProperty_Inner   = 0x138;
